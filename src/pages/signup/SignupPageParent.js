...
const SignupPageParent = () => {
  const [formData, setFormData] = useState({
    ...
    const handleSubmit = async (e) => {
      ...
      // matching data with the backend 
      const formattedData = {
    ...
    <div className="flex-1  pl-10 relative ">
      ...
      <div className=" relative top-[105px] left-[74px] items-center justify-center   ">
        ...
        onSubmit={handleSubmit}
          ...
          <button 
          type="submit"
          className= "relative top-[10px] w-[730px] h-[60px] bg-skooligreen1 text-white px-8 py-15 rounded-[12px]  hover:bg-skooligreen2 shadow-labelShadow font-inter font-[700] text-[32px] leading-[100%] ">
            Create Account
          </button>
          <p className="relative  w-[300px] h-[14px] left-[5px] top-[10px] font-[400] text-labelGray text-bodyMedium [text-shadow:0px_4px_4px_rgba(0,0,0,0.20)] ">
            ...
            {/* <a href="/login" className="relative w-[73px] h-[22px] left-[7px]  text-skooligreen1 "> Login</a>*/}
             <span 
...
export default SignupPageParent;
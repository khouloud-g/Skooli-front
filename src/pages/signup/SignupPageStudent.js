...
const schoolLevels = ["High School", "Middle School","Primary School" ];
const gradeOptions = {
...
const SignUpPageStudent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const formattedData = {
      ...
      parent_email: formData.parentEmail || null, // ask them to delet the optional (null)
      document_URL: formData.documentURL, // ifond it in the backend code so i add it too
    };
  ...
  return (
    ...
    <div className="flex-1  pl-10 relative ">
              ...
              <label className="absolute font-roboto -top-3 left-[34px] text-[17px] bg-white px-1 font-[400] text-labelGray text-bodyMedium [text-shadow:0px_4px_4px_rgba(0,0,0,0.20)]">
                First Name
                   ...
                   <input 
                      ...
                      className="w-[350px] h-[60px] text-[18px] p-3 border-[3px] border-[#00000024] items-center justify-center rounded-[8px] focus:border-skooligreen1 focus:outline-none" />
            </div>
              ...
              <label className="absolute font-roboto -top-3 left-[34px] text-[17px] bg-white px-1 font-[400] text-labelGray text-bodyMedium [text-shadow:0px_4px_4px_rgba(0,0,0,0.20)]">
                Last Name
                   ...
                   <input
                      ...
                      onChange={handleChange}
                      className="w-[350px] text-[17px] h-[60px] p-3 border-[3px] border-[#00000024] rounded-[8px] items-center justify-center focus:border-skooligreen1 focus:outline-none" />
            </div>
          </div>
          <div className="relative w-full items-center justify-center">
          <label className="absolute font-roboto -top-3 text-[18px] left-[34px] bg-white px-1 font-[400] text-labelGray text-bodyMedium [text-shadow:0px_4px_4px_rgba(0,0,0,0.2)]">
              Email
            </label>
                  <input 
                      type="email" 
                      ...
                      onChange={handleChange}
                      className="w-[730px] text-[17px] h-[60px] p-3 border-[3px] border-[#00000024] rounded-[8px] focus:border-skooligreen1 focus:outline-none" />
          </div>
            ...
            <label className="absolute font-roboto -top-3 left-[34px] text-[18px] bg-white px-1 font-[400] text-labelGray text-bodyMedium [text-shadow:0px_4px_4px_rgba(0,0,0,0.20)]">
                Password
                  ...
                  <input 
                      ...
                      onChange={handleChange}
                      className="w-[350px] text-[17px] h-[60px] p-3 border-[3px] border-[#00000024] rounded-[8px] focus:border-skooligreen1 focus:outline-none" />
            </div>
            ...
            <label className="absolute font-roboto -top-3 left-[34px] text-[18px] bg-white px-1 font-[400] text-labelGray text-bodyMedium [text-shadow:0px_4px_4px_rgba(0,0,0,0.20)]">
                Confirm Password
                  ...
                  <input 
                     ...
                     onChange={handleChange}
                     className="w-[350px] text-[18px] h-[60px] p-3 border-[3px] border-[#00000024] rounded-[8px] focus:border-skooligreen1 focus:outline-none" />
                 {error && <p className="text-gray-500 text-sm pl-3 left-[34px]">{error}</p>}
            </div>
          </div>
          <div className="relative w-full items-center justify-center">
      ...
      <Dropdown
        label="Current Grade"
        name="studyYear"
        options={schoolLevel ? gradeOptions[schoolLevel] : []}
        selectedOption={currentGrade}
        onChange={(value) => handleDropdownChange("studyYear", value)}
      />
    </div>
          ...
          <p className="relative  w-[300px] h-[14px] left-[5px] top-[10px] font-[400] text-labelGray text-bodyMedium [text-shadow:0px_4px_4px_rgba(0,0,0,0.20)] ">
